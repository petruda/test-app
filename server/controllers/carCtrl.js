module.exports = db => {
    return {
      ...
      findAll: (req, res) => {
        db.query(`SELECT id, name, year, capacity, tax, model, CASE WHEN liked IS TRUE THEN 'Da' ELSE 'Nu' END AS liked
        FROM "Car"
      ...
      find: (req, res) => {
        db.query(`SELECT id, name, year, capacity, tax, model, liked
